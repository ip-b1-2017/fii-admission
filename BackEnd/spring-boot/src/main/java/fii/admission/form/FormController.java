...
public class FormController {
	...
	@RequestMapping(value = "/form/{candidatcnp}", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/form/{candidatcnp}", method = RequestMethod.PUT)
	...
	@RequestMapping(value = "/form/{candidatcnp}", method = RequestMethod.DELETE)
