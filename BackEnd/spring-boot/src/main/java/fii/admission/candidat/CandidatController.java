...
public class CandidatController {
	...
	@RequestMapping(value = "/candidat/{cnp}", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/candidat/{cnp}", method = RequestMethod.PUT)
	...
	@RequestMapping(value = "/candidat/{cnp}", method = RequestMethod.DELETE)
