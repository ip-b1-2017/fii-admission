...
/
CREATE TABLE "User" (CNP INTEGER NOT NULL PRIMARY KEY, nume_la_nastere varchar(255) NOT NULL, telefon varchar(16) NOT NULL UNIQUE, prenume varchar(255) NOT NULL, role varchar(32) NOT NULL, adresa varchar(255) NOT NULL, nationalitate varchar(255) NOT NULL, adresa_documente varchar(255) NOT NULL, nume_actual varchar(255), prenume_tata varchar(255) NOT NULL, prenume_mama varchar(255) NOT NULL, sexul varchar(2) NOT NULL, data_nastere timestamp NOT NULL, tara_nastere varchar(70) NOT NULL, judet_nastere varchar(70) NOT NULL, localitate_nastere varchar(255) NOT NULL, cetatenie varchar(70) NOT NULL, limba_materna varchar(70) NOT NULL, etnie varchar(70), stare_civila varchar(70), date_CI varchar(255) NOT NULL, "date pasaport" varchar(255) NOT NULL, cazare_studii varchar(2) NOT NULL, cazare_admitere varchar(2) NOT NULL, stare_sociala_speciala varchar(255), dizabilitati varchar(2), nr_chitanta integer(10), suma_taxa integer(10), NoteUserCNP integer(13) NOT NULL, NoteExamenid integer(10) NOT NULL);
