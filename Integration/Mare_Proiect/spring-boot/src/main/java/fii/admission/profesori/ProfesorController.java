...
public class ProfesorController {
    ...
    public ResponseEntity<SuccessEntity> updateProfesor(@PathVariable("cnp") String cnp, @RequestBody Profesor prof) {
    ...
    public ResponseEntity<SuccessEntity> deleteProfesor(@PathVariable("cnp") String cnp) {
    ...
    public ResponseEntity<SuccessEntity> insertProfesor(@RequestBody Profesor prof) {
